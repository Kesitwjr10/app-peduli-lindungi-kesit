...
import {I_Covid, I_CheckIn, I_Child,} from "../../assets";
        ...
        <View style={styles.bgApp}>
            <View style={styles.item}>
                ...
                <View style={{flexDirection: 'row'}}>
                    <Image source={I_Covid} style={styles.gambar1}/>
            ...
            <View style={{borderBottomColor: 'black',borderBottomWidth: StyleSheet.hairlineWidth,width:206,marginStart:80,}}/>
                <View style={{flexDirection: 'row'}}>
                    <Image source={I_CheckIn} style={styles.gambar2}/>
                        <View style={{flexDirection: 'column'}}>
            ...
            <View style={{borderBottomColor: 'black',borderBottomWidth: StyleSheet.hairlineWidth,width:206,marginStart:80,}}/>
                <View style={{flexDirection: 'row'}}>
                    <Image source={I_Child} style={styles.gambar2}/>
                        <View style={{flexDirection: 'column'}}>
